...
import { Eye, EyeSlash, Lock, ShieldCheck, User as UserIcon } from "phosphor-react-native";
        ...
        >
          <View style={styles.header}>
            <View style={styles.logoBadge}>
              <ShieldCheck size={34} color={colors.onBrandSecondary} weight="fill" />
            </View>
            <Text style={styles.brandName}>Admin Access</Text>
            <Text style={styles.brandTag}>Customer Management Administration</Text>
          </View>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.field}>
              ...
              <View style={styles.inputWrap}>
                ...
                />
                <Pressable onPress={() => setShowPassword((v) => !v)} hitSlop={8} testID="toggle-admin-password">
                  {showPassword ? (
...
const useStyles = makeStyles((colors) => ({
  ...
  brandName: { color: colors.brandPrimary, fontSize: 24, fontWeight: "800" },
  brandTag: { color: colors.muted, fontSize: 14, textAlign: "center" },
  card: {
  ...
  input: { flex: 1, color: colors.onSurface, fontSize: 15, height: "100%" },
  button: {
  ...
  buttonText: { color: colors.onBrandPrimary, fontSize: 16, fontWeight: "800", letterSpacing: 0.5 },
}));
